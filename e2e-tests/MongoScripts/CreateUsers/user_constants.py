...
affiliations = ["Poznan University of Technology", "Cambridge", "Berlin Technische Universitat"]

email_providers = [ "gmail.com", "o2.pl", "tlen.pl", "cs.put.poznan.pl", "pudelek.pl", "eu.com" ]

addresses = [ "Warsaw", "Szczecin", "Poznan", "New York", "Berlin"]
